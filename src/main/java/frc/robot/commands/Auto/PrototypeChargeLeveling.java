...
public class PrototypeChargeLeveling extends CommandBase {
  ...
  public PrototypeChargeLeveling(DriveSubsystem DriveSubsystem, AutoBalanceDirection direction, double seconds, double speed) {
  ...
  public boolean isFinished() {
    ...
    switch(direction){
      ...
      case FORWARD:
          if(/*Timer.getFPGATimestamp() >= endTime|| m_DriveSubsystem.getPitch() + zeroOffset > 9 ){
            return true;
          }
          else{
            return false;
    ...
    */
    ...
    return m_DriveSubsystem.getPitch() + zeroOffset < 9;
