...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    // SPARK MAX CAN IDs
    public static final int kFrontLeftDrivingCanId = 5; //Motor # 7
    public static final int kRearLeftDrivingCanId = 1; //Motor # 9
    public static final int kFrontRightDrivingCanId = 7; //Motor # 3
    public static final int kRearRightDrivingCanId = 3; //Motor # 5

    public static final int kFrontLeftTurningCanId = 2; //Motor # 6
    public static final int kRearLeftTurningCanId = 6; //Motor # 8
    public static final int kFrontRightTurningCanId = 8; //Motor # 2
    public static final int kRearRightTurningCanId = 4; //Motor # 4
  ...
  public static final class ModuleConstants {
    ...
    public static final double kTurningEncoderPositionFactor = (2 * Math.PI)/(12*(62/14)); // radians
  ...
  public static final class OIConstants {
    ...
    public static final double kThetaDriveDeadband = .1;
  }
  ...
  public static final class ManipulatorConstants {
    ...
    //Wrist
    public static final int kwristMotor = 11; //Motor # 1
    public static final int kwristFollowerMotor = 12; //Motor # 0
