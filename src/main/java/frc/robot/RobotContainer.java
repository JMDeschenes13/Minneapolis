...
import frc.robot.commands.Auto.AutoDriveDistance;
...
public class RobotContainer {
  ...
  private final SetBrake m_setBrake = new SetBrake(m_robotDrive);
  private final SetCoast m_setCoast = new SetCoast(m_robotDrive);
  ...
  public RobotContainer() {
    ...
    m_robotDrive.setDefaultCommand(
        ...
        new RunCommand(
            () -> m_robotDrive.drive(
                ...
                -MathUtil.applyDeadband(m_driveJoystick.getRawAxis(3), OIConstants.kThetaDriveDeadband),
                !m_driveJoystick.getRawButton(2), true),
            m_robotDrive));
    ...
    autoMap.put("PlaceConeDrive", new SequentialCommandGroup(
        ...
        new ParallelCommandGroup(
            new DriveForTime(m_robotDrive, 3.25,.25),// 3.36
    ...
    autoMap.put("PlaceConeDriveOutLevel", new SequentialCommandGroup(
        ...
        new ClawOpen(m_claw),
        new ParallelCommandGroup(
            new AutoDriveFor(m_robotDrive, .35,0,0, false, 3.036),
            new WristToDrive(m_wrist)),
        new DoTimeOut(.1),
        new AutoDriveFor(m_robotDrive, -.35, 0,0, false, .6),
        new ChargeStationLevel(m_robotDrive, true),
        new AutoDriveFor(m_robotDrive, .15, 0, 0, false, .35),
    ...
    autoMap.put("PlaceConeLevel", new SequentialCommandGroup(
        ...
        new DoTimeOut(.8),
        new ClawOpen(m_claw),
        new SetBrake(m_robotDrive),
    
        new ParallelCommandGroup(
            //new PrototypeChargeLeveling(m_robotDrive, AutoBalanceDirection.BACKWARD, 7, .2),
            new SequentialCommandGroup(
                new DriveForTime(m_robotDrive, 1.45, .25),
                new ChargeStationLevel(m_robotDrive, false)
            ),
        ...
        //new PrototypeChargeLeveling(m_robotDrive,   -.55,-.15),
        //new InstantCommand(() -> m_robotDrive.setX())

    ));

    autoMap.put("PrototypeLeveling", new SequentialCommandGroup(
        //new PrototypeChargeLeveling(m_robotDrive, .5, 3)
    ));
    ...
    autoMap.put("PrototypeTrajectoryDriveOutLeveling", new SequentialCommandGroup(
        ...
        new ClawOpen(m_claw),
        new SetBrake(m_robotDrive)
        //new PrototypeChargeLeveling(m_robotDrive, AutoBalanceDirection.FORWARD)
    ));
    ...
    autoMap.put("PrototypeDriveOutLevel", new SequentialCommandGroup(
        ...
        new AutoDriveDistance(m_robotDrive, 1, .5),
        
        new ChargeStationLevel(m_robotDrive, true),
        new AutoDriveDistance(m_robotDrive, .25, 0.5),
        new InstantCommand(()-> m_robotDrive.setX())
    ));
  ...
  private void configureButtonBindings() {
    ...
    //new JoystickButton(m_driveJoystick, 11).onTrue(new InstantCommand(() -> m_orchestra.play()));
